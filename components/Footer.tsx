export const Footer = ({ loading = false }: { loading?: boolean }) => {
  if (loading) {
    return (
      <div
        className="text-darkBlueText px-10 animate-pulse"
        style={{ flex: "0 1 40px" }}
      >
  ...
  return (
    <div className="text-darkBlueText px-10" style={{ flex: "0 1 40px" }}>
      ...
      <p className="text-justify max-sm:text-xs max-md:text-sm max-lg:text-base xl:text-base">
        ...
        geen enkele garantie, noch uitdrukkelijk noch stilzwijgend, met
        betrekking tot de volledigheid, nauwkeurigheid, betrouwbaarheid,
        geschiktheid of beschikbaarheid van de website of de informatie,
        producten, diensten of gerelateerde afbeeldingen op de website voor welk
        doel dan ook. Elk vertrouwen dat u stelt in dergelijke informatie is
        derhalve uitsluitend voor eigen risico.
      </p>
    </div>
  );
};
